                        ...
                        <div class="flex items-top block gap-4 mb-4">
                            ...
                            <div class="contacts w-3/5 ">
                                <div class="flex gap-1 lg:gap-4 mb-4">
                                    <input class="form-input flex-1" placeholder="Nom" type="text" name="client_contact_name[]">
                                    <input class="form-input flex-1" placeholder="Téléphone" type="text" name="client_contact_telephone[]">
                                    <div class=" w-12 ">
